...
func New(dependencies Dependencies) http.Handler {
	...
	mux.HandleFunc("GET /api/v1/houses/mine", api.listOwnedHouses)
	mux.HandleFunc("GET /api/v1/houses/{id}", api.getHouse)
	mux.HandleFunc("POST /api/v1/houses", api.createHouse)
	mux.HandleFunc("PATCH /api/v1/houses/{id}", api.updateOwnedHouse)
	mux.HandleFunc("DELETE /api/v1/houses/{id}", api.deleteOwnedHouse)
